...
function PostDetails({ slug, post }) {
  ...
  return (
    <div className="w-screen h-screen">
      ...
      <main className="max-w-screen-lg mx-auto  flex flex-col items-center justify-center">
        <div className="w-full lg:w-[60%] h-auto max-h-screen ">
          {post.mainImage && (
            <Image
      ...
      <div className="p-4 lg:p-10">
        ...
        <p onClick={navlocation} className="hover:underline cursor-pointer">
          {post.location.title}
        </p>
